...
void WriterBMP::WriteDestFile ()
{
  ...
  os.write ("\0\0\0\0", 4);
  os.write ((char*)UnpackLittle32 (d, (uint32)BMP_HEADER_SIZE), 4);
  os.write ((char*)UnpackLittle32 (d, 40), 4);   // Palette offset
  os.write ((char*)UnpackLittle32 (d, (uint32)width ), 4);
  os.write ((char*)UnpackLittle32 (d, (uint32)height), 4);
  ...
  os.write ((char*)UnpackLittle32 (d, (uint32)destSize), 4);
  ...
  double bumpHeight) const
{
  ...
  // range.
  uint8 xc, yc, zc;
  xc = (uint8)((uint)((floor)((vxc + 1.0) * 127.5)) & 0xff);
